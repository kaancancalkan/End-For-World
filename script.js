...
$(function()
{
    var timer, playerTrack = $("#player-track"), bgArtwork = $('#bg-artwork'), bgArtworkUrl, albumName = $('#album-name'), trackName = $('#track-name'), albumArt = $('#album-art'), sArea = $('#s-area'), seekBar = $('#seek-bar'), trackTime = $('#track-time'), insTime = $('#ins-time'), sHover = $('#s-hover'), playPauseButton = $("#play-pause-button"),  i = playPauseButton.find('i'), tProgress = $('#current-time'), tTime = $('#track-length'), seekT, seekLoc, seekBarPos, cM, ctMinutes, ctSeconds, curMinutes, curSeconds, durMinutes, durSeconds, playProgress, bTime, nTime = 0, buffInterval = null, tFlag = false, albums = [' La belle étoile','Home','Proxy (Original Mix)'], trackNames = ['Andrea Lindsay - Demain Des Laube','Alex Skrindo - Me & You','Kaaze - Electro Boy',], albumArtworks = ['_1','_2','_3'], trackUrl = ['https://raw.githubusercontent.com/cancalkan/End-For-World/main/Songs/Andrea%20Lindsay%20-%20%20Demain%20Des%20Laube.mp3?token=AO3LYBSBITM3YEZL6N74PCS7YZOQ2','https://github.com/cancalkan/End-For-World/blob/main/Songs/Erik%20Satie%20-%20Gnossienne%20No.1.mp3','https://raw.githubusercontent.com/himalayasingh/music-player-1/master/music/5.mp3'], playPreviousTrackButton = $('#play-previous'), playNextTrackButton = $('#play-next'), currIndex = -1;
